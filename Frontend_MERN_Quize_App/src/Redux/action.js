...
export const getAllUserDataFromBackend = (payload) => (dispatch) => {
  ...
  axios
    .get("https://localhost:3755/getuser")
    .then((res) => {
...
export const deleteUserByAdmin = (payload) => (dispatch) => {
  axios
    .delete(`https://localhost:3755/${payload}`)
    .then((response) => {
...
export const postQuizObj = (obj) => (dispatch) => {
  axios
    .post("https://localhost:3755/admin", obj)
    .then((res) => {
...
export const fetchQuizDataFrombackend = () => (dispatch) => {
  axios
    .get("https://localhost:3755/api/quiz")
...
export const getQuiz = (params) => (dispatch) => {
  axios
    .get(`https://localhost:3755/quiz/${params.id}`)
    .then((res) => {
...
export const postQuizResult = (obj) => (dispatch) => {
  ...
  axios
    .post(`https://localhost:3755/userResult/${userId}`, obj)
    .then((res) => {
