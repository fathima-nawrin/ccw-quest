      ...
      <div className="md:w-11/12 mx-auto bg-gray-100/10 flex p-4 my-6 mt-24">
        <div className="w-7/12 ">
          ...
          <div className=" ml-32 leading-normal">
            ...
            The project, developed by S6 CSE students at MES Kunnukara College, provides a focused platform for practicing CCW subjects in computer science. Through interactive quizzes and customization options, students can tailor their learning experience. Real-time feedback and progress tracking empower students to improve their understanding and excel in CCW exams.
            </p>
          </div>
