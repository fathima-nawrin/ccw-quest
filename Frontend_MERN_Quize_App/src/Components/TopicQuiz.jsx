      ...
      <div className="grid grid-cols-2 w-11/12 p-10 m-auto gap-8 shadow-2xl">
          ...
          <Link to="/quiz/html">
            ...
            <div className="border-2 cursor-pointer topicdiv text-white font-sans text-4xl font-bold  h-36 justify-items-center rounded-2xl pl-10 flex ">
              <div className="w-3/5 h-full bg-rgb(27,169,76)">
                <h1 className="pt-12 pl-16 topicdivh1 ">DATA STRUCTURES</h1>
              </div>
              <img className="w-2/5  rounded-2xl" src="/ds.png" alt="" />
            </div>
          </Link>
        ) : (
          <Link to="/register">
        ...
        {userId ? (
          <Link to="/quiz/css">
            ...
            <div className="border-2 cursor-pointer topicdiv text-white font-sans text-4xl font-bold  h-36 justify-items-center rounded-2xl pl-10 flex ">
              <div className="w-3/5 h-full bg-rgb(27,169,76)">
                <h1 className="pt-12 pl-16 topicdivh1">OPERATING SYSTEMS</h1>
              </div>
              <img
        ...
        {userId ? (
          <Link to="/quiz/javascript">
            ...
            <div className="border-2 cursor-pointer topicdiv text-white font-sans text-4xl font-bold  h-36 justify-items-center rounded-2xl pl-10 flex ">
              <div className="w-3/5  h-full bg-rgb(27,169,76)">
                <h1 className="pt-12 pl-16 topicdivh1">COA</h1>
              </div>
              <img
        ...
        {userId ? (
          <Link to="/quiz/react">
            ...
            <div className="border-2 cursor-pointer topicdiv text-white font-sans text-4xl font-bold  h-36 justify-items-center rounded-2xl pl-10 flex ">
              <div className="w-3/5 h-full bg-rgb(27,169,76)">
                <h1 className="pt-12 pl-16 topicdivh1">DBMS</h1>
              </div>
              <img className="w-2/5 rounded-2xl " src="./dbms.png" alt="" />
            </div>
          </Link>
        ) : (
          <Link to="/register">
        ...
        {userId ? (
          <Link to="/quiz/redux">
            ...
            <div className="border-2 cursor-pointer topicdiv text-white font-sans text-4xl font-bold  h-36 justify-items-center rounded-2xl pl-10 flex ">
              <div className="w-3/5 h-full bg-rgb(27,169,76)">
                <h1 className="pt-12 pl-16 topicdivh1">FLAT</h1>
              </div>
              <img
